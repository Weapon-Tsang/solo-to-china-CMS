...
const guides = {
  ...
  ai: { icon: KeyRound, title: "Enable AI extraction", description: "Add the API key to the server environment, then restart the engine. Captures already queued as needs_ai remain safe.", steps: ["Set OPENAI_API_KEY in .env or the process environment.", "Optionally select OPENAI_MODEL; the default is gpt-5-mini.", "Restart npm start and confirm the top status badge changes to AI ready."], code: "$env:OPENAI_API_KEY = \"your-key\"\nnpm start" },
