...
IMAGE="asia-east1-docker.pkg.dev/${PROJECT_ID}/solo-to-china/engine:2.0.70"
...
AI_PROVIDER_RECOVERY_SUCCESSES=5
AI_CONCURRENCY_MODE=auto
AI_CONCURRENCY_INITIAL=2
AI_CONCURRENCY_MAX=4
AI_CONCURRENCY_SUCCESS_WINDOW=12
MANUAL_SOURCE_MAX_FILE_BYTES=67108864
MANUAL_SOURCE_MAX_IMAGE_BYTES=20971520
MANUAL_SOURCE_MAX_VIDEO_BYTES=268435456
MANUAL_SOURCE_MAX_TOTAL_BYTES=314572800
MANUAL_SOURCE_MAX_IMAGES=30
MANUAL_SOURCE_GCS_BUCKET=solo-to-china-video-463584560230
VERTEX_AI_BATCH_ENABLED=true
VERTEX_AI_BATCH_BUCKET=solo-to-china-video-463584560230
VERTEX_AI_BATCH_MIN_REQUESTS=10
VERTEX_AI_BATCH_MAX_REQUESTS=1000
VERTEX_AI_BATCH_POLL_MS=60000
VERTEX_AI_BATCH_MAX_INPUT_BYTES=134217728
...
FRONTEND_CONTRACT_COMMIT_SHA=b231b1d54915ceef6a7f52b907ba5d7c1d79463d
