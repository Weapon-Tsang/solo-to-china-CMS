...
const ISSUE_GUIDANCE = {
  ...
  UNIFORM_SECTION_RHYTHM: ['章节节奏过于整齐', '各章节机械地使用相同长度和结构，没有按读者决策分配篇幅。', '让章节深度服从实际问题，不必维持统一模板。'],
  EXCESSIVE_HEDGING: ['正文保留语过多', '大量 may、might 等措辞让已有证据支持的结论也显得含糊。', '只在证据确有不确定性时保留限定。'],
  NO_TRAVELER_DECISION: ['没有帮助旅行者做决定', '正文提供了信息，但缺少可执行的选择或下一步。', '明确读者在什么条件下应该怎么做。'],
  NO_CAUSAL_FLOW: ['正文缺少因果与条件逻辑', '事实之间没有说明为什么重要、会带来什么后果或如何取舍。', '补足因果、条件和替代方案的连接。'],
