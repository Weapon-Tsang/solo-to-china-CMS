...
- [Final code CI run 35633072724](https://github.com/Weapon-Tsang/solo-to-china-CMS/actions/runs/35633072724) passed its consolidated offline gate and actual runtime image startup smoke on commit `4fe1c60`, including the API/Worker role check. This is a disposable CI image; it is not an immutable production image published to Artifact Registry.
...
| CI runtime image startup smoke for 2.0.48 | PASS on commit `4fe1c60` |
| Published immutable production image and isolated readiness on the VM | NOT DONE |
