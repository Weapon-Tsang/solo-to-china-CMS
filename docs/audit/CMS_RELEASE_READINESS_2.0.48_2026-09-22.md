...
| Gate | Status |
|---|---|
| Full bundle → media 429 exhaustion → process restart → explicit grant → only missing image → independent QA → one mock WordPress draft (M35, X01–X07) | NOT TESTED end to end |
