...
This operational note applies the active Content Production Strategy 1.8 to Xiaohongshu Favorites Sync. It does not create a new strategy version or change the editorial approval gate.
